...
> = React.memo((props: Props) => {
  ...
  return (
    <div
      className="block p-6 bg-white rounded-lg shadow hover:shadow-lg transition-shadow space-y-5 cursor-pointer"
      onClick={() => onCardClik({ id, name })}
    >
